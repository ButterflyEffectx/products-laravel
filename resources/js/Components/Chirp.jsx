...
export default function Chirp({ chirp }) {
    ...
    //TODO: การรับ props โดย props ใน component นี้คือ chirp (ชื่อผู้เขียน เวลาโพส เนื้อหา) โดย { auth } จะเก็บข้อมูลผู้ใช้

    const [editing, setEditing] = useState(false);
    //TODO: state สำหรับเช็คว่าผู้ใช้แก้ไขหรือไม่

    const { data, setData, patch, clearErrors, reset, errors } = useForm({
        message: chirp.message,
    }); //TODO: data สำหรับเก็บ message ที่ถูกแก้ไข
